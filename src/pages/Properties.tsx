  ...
  return (
    <>
      ...
      <SectionContainer>
        ...
        />
        <CardContainer className="p-5 xl:p-12 2xl:p-[100px]">
          <div className="flex flex-wrap gap-5 xl:gap-7 2xl:gap-12">
            ...
            <div className="flex flex-col gap-4 w-full xl:max-w-[568px] 2xl:max-w-[670px]">
              ...
              <div className="flex gap-4 flex-col xl:flex-row ">
                <div className="relative ">
                  <input
                    className="h-14 2xl:h-16 w-full rounded-lg bg-gray-10 border border-gray-15 py-4 px-[54px] 2xl:py-5 text-white 2xl:text-base"
                    type="tel"
                    name="contactMethod"
                    id="phoneMethod"
                  ></input>
            ...
            <div className="flex flex-col gap-5 xl:flex-row xl:justify-between w-full">
              <div className="flex gap-4 justify-center items-center">
                ...
                <p className="text-gray-60 font-medium text-sm xl:text-[16px] 2xl:text-base">
                  I agree with{" "}
