...
export default function Home() {
  return (
    <>
      <HeroSection />
      <FeaturesSection />
      <section className="xl:max-w-[1600px] w-full mx-auto my-40">
        <div className="w-full">
          ...
          <div className="flex justify-between border-t border-gray-15 py-5 mt-12">
            <div>
              <span className="text-white text-xl font-medium leading-[30px]">01</span>
              <span className="text-gray-60 text-xl font-medium leading-[30px]"> of 60</span>
            </div>
            <PaginationButtons />
          </div>
        </div>
