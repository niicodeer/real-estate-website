...
export default function SectionHeader({ title, text, buttonText }: SectionHeaderProps) {
  return (
    <div className="flex flex-wrap w-full mb-10 lg:mb-14 2xl:mb-20 justify-between relative">
      <div className="absolute -top-6 lg:-top-10 -left-2 lg:-left-4 h-5 lg:h-7">
        <StarsHeader />
      </div>
      <div className="lg:w-4/5 w-full 2xl:mb-6 lg:mb-4 mb-0 xl:max-w-[1200px]">
        <h1 className="text-3xl 2xl:text-5xl lg:text-4xl font-semibold mb-2 text-white xl:leading-[72px]">
          {title}
        </h1>
