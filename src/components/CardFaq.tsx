  ...
  return (
    <CardContainer>
      <div className="text-white p-12 min-w-[360px] xl:max-w-[412px] 2xl:max-w-[512px] flex flex-col gap-7 justify-center items-start">
        <h2 className="text-base xl:text-xl 2xl:text-2xl font-semibold h-[72px]">{question}</h2>
        <p className="text-sm xl:text-[16px] 2xl:text-base text-gray-60">{description}</p>
