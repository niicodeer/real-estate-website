  ...
  return (
    <>
      {primary ? (
        ...
        <button
          className={`inline-flex justify-center items-center bg-gray-10 border-2 border-inset border-gray-15 py-3 2xl:py-4 px-5 2xl:px-6 focus:outline-none hover:bg-gray-10 rounded-lg text-sm 2xl:text-lg text-white ${className}`}
        >
          {text}
        </button>
      ) : (
